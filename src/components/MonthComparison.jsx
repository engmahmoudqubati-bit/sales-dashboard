    ...
    <div style={{ ...cardStyle, padding:"20px", marginBottom:"1.5rem" }}>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={chartData}
          margin={{ top:36, right: isRTL?10:30, left: isRTL?100:10, bottom:5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={gridColor} />
          <XAxis dataKey="month" tick={{ fontSize:13, fontWeight:"700", fill:axisColor }} />
          <YAxis orientation={isRTL?"right":"left"} tick={{ fontSize:12, fontWeight:"700", fill:axisColor }} tickFormatter={v=>`SAR ${(v/1000).toFixed(0)}K`} width={80} />
